...
in stored capture order, use microsecond timestamps, and include stable replay,
file, and row ordinals. Nullable receive timestamp, sequence, and sequence-scope
columns expose venue ordering metadata when present. Typed trade, order-book,
and point columns support compiled consumers. With raw order-book updates,
