...
| `events(source, market, from_=None, to=None, materialize_orderbooks=True)` | List of normalized events | Load mixed event types into scripts or notebooks |
...
| `l2_snapshots(source, market, from_=None, to=None, materialize_orderbooks=True)` | List of complete orderbook rows | Order book reconstruction and microstructure analysis |
