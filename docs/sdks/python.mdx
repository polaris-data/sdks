...
| `trades(source, market, from_=None, to=None)` | Iterator of normalized trades | Analyze executions |
...
| `funding_rates(source, market, from_=None, to=None)` | Iterator of funding-rate point series rows | Perpetual funding studies and carry modeling |
| `mark_prices(source, market, from_=None, to=None)` | Iterator of mark-price point series rows | Basis analysis, mark tracking, and liquidation-related research |
...
| `bbo(source, market, from_=None, to=None, interval=None)` | Iterator of best bid/offer quotes | Spread tracking, quote analytics, and top-of-book monitoring |
| `depth_metrics(source, market, from_=None, to=None, depth_pct=0.01, slippage_notional=10000.0)` | Iterator of derived liquidity metrics | Liquidity analysis and market impact estimation |
